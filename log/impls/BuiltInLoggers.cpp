...
BuiltInLoggers::ConsoleLogger::ConsoleLogger(const std::string& name) : BaseLogger(name.c_str())
{
}

BuiltInLoggers::SimpleFileLogger::SimpleFileLogger(const std::string& name, const std::string& file) : BaseLogger(name.c_str())
{
