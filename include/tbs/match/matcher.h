...
public:
     ...
     * @param f 用户定义的处理函数对象
     */
    Matcher(V&& value, F f) : _value(std::move(value)), _f(f)
    {
    }
     ...
     * @param f 用户定义的处理函数对象
     */
    Matcher(const V& value, E equals, F f) : _value(value), _equals(equals), _f(f)
    {
    }
     ...
     * @param f 用户定义的处理函数对象
     */
    Matcher(V&& value, E equals, F f) : _value(std::move(value)), _equals(equals), _f(f)
    {
    }
